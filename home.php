 <!-- Header-->
 <header class="bg-dark py-5" id="main-header" style="height: 71vh !important;">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder"><?php echo $_settings->info('name') ?></h1>
            <p class="lead fw-normal text-white-50 mb-0"> Арендуйте мотоциклов прямо сейчас! </p>
        </div>
    </div>
</header>
<section class="py-5">
                ...
                <div class="card bike-item shadow">
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            ...
                            <!-- bike price-->
                                <span><b> Ежедневная ставка: </b><?php echo number_format($row['daily_rate']) ?></span>
                        </div>
                        <p class="m-0"><small><b> Торговая марка: </b>  <?php echo $row['brand'] ?></small> <br>
