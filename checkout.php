...
<section class="py-5">
    <div class="container">
        <div class="card rounded-0">
            ...
            <h3 class="text-center"><b> Оформить заказ </b></h3>
            ...
            <form action="" id="place_order">
                ...
                <div class="row row-col-1 justify-content-center">
                    ...
                    <label for="" class="control-label"> Тип заказа </label>
                    </div>
                    <div class="form-group d-flex pl-2">
                        <div class="custom-control custom-radio">
                          ...
                          <label for="customRadio4" class="custom-control-label"> Доставка </label>
                        </div>
                        <div class="custom-control custom-radio ml-3">
                          ...
                          <label for="customRadio5" class="custom-control-label"> Для самовывоза </label>
                        </div>
                      </div>
                        ...
                        <hr>
                        <div class="col my-3">
                        <h4 class="text-muted"> Метод оплаты </h4>
                            <div class="d-flex w-100 justify-content-between">
                                <button class="btn btn-flat btn-dark"> Оплата при доставке </button>
