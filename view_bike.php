    ...
    <div class="container px-4 px-lg-5 my-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <br>
                <span><small><b> Доступная единица измерения: </b> <span id="avail"><?php echo $quantity ?></span></small></span>
                </div>
                <button class="btn btn-outline-dark flex-shrink-0" type="button" id="book_bike">
                    <i class="bi-cart-fill me-1"></i>
                    Забронировать этот мотоцикла:
                </button>
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4"> Связанные мотоцикла </h2>
                ...
                <div class="card h-100 bike-item">
                    ...
                    <div class="card-body p-4">
                        <div class="">
                            ...
                            <!-- bike price-->
                            <span><b> Стоимость: </b><?php echo number_format($row['daily_rate']) ?></span>
                            <p class="m-0"><small> Торговая марка: <?php echo $row['brand'] ?></small> <br>
...
<script>
    $(function(){
        ...
        $('#book_bike').click(function(){
            ...
            uni_modal("<span class='fas fa-window-restore'></span> Бронирование прокат мотоциклов","book_to_rent.php?id=<?php echo isset($id) ? $id : '' ?>",'mid-large')
        })
    })
</script>