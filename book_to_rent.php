...
<div class="container-fluid">
    <form action="" id="book-form">
        ...
        <div class="form-group">
            <label for="date_start" class="control-label"><i class="fas fa-calendar-check"></i> Дата получения </label>
            <input type="date" name="date_start" id="date_start" class="form-control form-conrtrol-sm rounded-2" value="" required>
        </div>
        <div class="form-group">
            <label for="date_end" class="control-label"><i class="fas fa-calendar-day"></i> Дата возврата </label>
            <input type="date" name="date_end" id="date_end" class="form-control form-conrtrol-sm rounded-2" value="" required>
        </div>
        <div id="msg" class="text-danger"></div>
        <div id="check-availability-loader" class="d-none">
            <center>
                <div class="d-flex align-items-center col-md-6">
                    <strong><i class="fas fa-user-clock"></i> Проверка наличия... </strong>
                    <div class="spinner-border ml-auto" role="status" aria-hidden="true"></div>
                </div>
            </center>
        </div>
        <div class="form-group">
            <label for="rent_days" class="control-label"><i class="far fa-calendar-alt"></i> Дней в аренду </label>
        ...
        <div class="form-group">
            <label for="daily_rate" class="control-label"><i class="far fa-calendar-minus"></i> Дневная норма мотоцикла </label>
        ...
        <div class="form-group">
            <label for="amount" class="control-label"><i class="fas fa-file-invoice-dollar"></i> Общая сумма </label>
