...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title"><i class="fab fa-innosoft"></i> Системная информация </h5>
		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label"><i class="fas fa-file-contract"></i> Имя системы: </label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label"><i class="fas fa-file-signature"></i> Краткое название системы: </label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
			<div class="form-group">
				<label for="" class="control-label"><i class="fas fa-house-user"></i> О нас: </label>
			...
			<div class="form-group">
				<label for="" class="control-label"><i class="fas fa-sign"></i> Политика конфиденциальности: </label>
