...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><i class="fas fa-file-signature"></i> <?php echo isset($id) ? "Обновить ": "Создавать новое " ?> мотоцыкла </h3>
	</div>
	<div class="card-body">
		<form action="" id="bike-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
            <div class="form-group">
				<label for="category_id" class="control-label"><i class="fas fa-stream"></i> Категория: </label>
            ...
            <div class="form-group">
				<label for="brand_id" class="control-label"><i class="fab fa-bandcamp"></i> Категория бренда: </label>
			...
			<div class="form-group">
				<label for="bike_model" class="control-label"><i class="fas fa-ticket-alt"></i> Модель: </label>
            ...
            <div class="form-group">
                <label for="quantity" class="control-label"><i class="fas fa-vote-yea"></i> Доступная единица измерения:</label>
            ...
            <div class="form-group">
                <label for="daily_rate" class="control-label"><i class="fas fa-wallet"></i> Ежедневная ставка: </label>
            ...
            <div class="form-group">
				<label for="description" class="control-label"><i class="fas fa-newspaper"></i> Описание: </label>
            ...
            <div class="form-group">
				<label for="" class="control-label"><i class="fas fa-file-image"></i> Уменьшенное изображение: </label>
            ...
            <div class="form-group">
				<label for="" class="control-label"><i class="fas fa-images"></i> Изображений </label>
				<div class="custom-file">
	...
	<div class="card-footer" style="text-align: center;">
		<button class="btn btn-primary btn-sm rounded-2" form="bike-form"><i class="fas fa-clipboard-check"></i> Сохранить </button>
		<a class="btn btn-danger btn-sm rounded-2" href="?page=bike"><i class="fas fa-window-close"></i> Oтменить </a>
	</div>
</div>
<script>
